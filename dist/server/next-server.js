...
function () {
  function Server() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        _ref$errorCodeMapper = _ref.errorCodeMapper,
        errorCodeMapper = _ref$errorCodeMapper === void 0 ? null : _ref$errorCodeMapper;
    ...
    this.errorCodeMapper = errorCodeMapper; // Only serverRuntimeConfig needs the default
  ...
  (0, _createClass2.default)(Server, [{
    ...
    value: function handleRequest(req, res, parsedUrl) {
      ...
      return this.run(req, res, parsedUrl).catch(function (err) {
        ...
        if (_this.errorCodeMapper) {
          var customCode = _this.errorCodeMapper(err);

          res.statusCode = (0, _isInteger.default)(customCode) ? customCode : 500;
          res.end(err);
        }
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 14:
                ...
                customCode = this.errorCodeMapper(_context11.t0);
                res.statusCode = (0, _isInteger.default)(customCode) ? customCode : 500;
    ...
    value: function () {
      ...
      function serveStatic(_x39, _x40, _x41) {
